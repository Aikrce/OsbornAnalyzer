  ...
  useEffect(() => {
    if (isOpen) {
      ...
      if (currentConfig) {
        setConfig({
          ...currentConfig,
          model: currentConfig.model as 'deepseek-coder' | 'deepseek-chat',
        });
      }
    }
  }, [isOpen]);
      ...
      <DialogContent className='sm:max-w-[500px]'>
        ...
        <div className='space-y-4'>
          ...
          <div className='space-y-2'>
            ...
            <Select
              value={config.model}
              onValueChange={(value: 'deepseek-coder' | 'deepseek-chat') =>
          ...
          <div className='space-y-2'>
            ...
            />
            <p className='text-sm text-muted-foreground'>控制回答的最大长度</p>
          </div>
        </div>
