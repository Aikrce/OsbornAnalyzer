...
const SettingsPage: React.FC = memo(() => {
  const [activeTab, setActiveTab] = useState<
    'ai' | 'preferences' | 'notifications' | 'security' | 'data'
  >('ai');
  ...
  // 删除API配置
  const handleDeleteApiConfig = useCallback(
    (id: string) => {
  ...
  // 设置活跃的API配置
  const handleSetActiveApiConfig = useCallback(
    (id: string) => {
  ...
  const updatePreference = useCallback(
    ...
    [appPreferences, showNotification, setTheme]
  );
                        ...
                        >
                          <div className='flex items-start justify-between mb-3'>
                            ...
                            <div className='flex items-center space-x-2'>
                              ...
                              <Button
                                ...
                                variant='ghost'
                                onClick={() =>
                                  handleDeleteApiConfig(apiConfig.id)
                                }
                          ...
                          <div className='space-y-2 text-sm'>
                            <div className='flex items-center justify-between'>
                              ...
                              <span className='font-mono text-xs bg-gray-100 px-2 py-1 rounded'>
                                ...
                                {apiConfig.apiKey.substring(
                                  apiConfig.apiKey.length - 4
                                )}
                              </span>
                            </div>
                            <div className='flex items-center justify-between'>
                          ...
                          {!apiConfig.isActive && (
                            <Button
                              size='sm'
                              onClick={() =>
                                handleSetActiveApiConfig(apiConfig.id)
                              }
                ...
                {showAddApiForm && (
                  <div className='mt-6 p-4 border border-gray-200 rounded-lg bg-gray-50'>
                    ...
                    <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                      ...
                      <div>
                        ...
                        <Select
                          ...
                          onValueChange={value =>
                            setNewApiConfig({ ...newApiConfig, model: value })
                          }
                        >
                          <SelectTrigger className='mt-1'>
                            <SelectValue />
                    ...
                    <div className='flex justify-end space-x-2 mt-4'>
                      ...
                      <Button onClick={handleAddApiConfig}>添加配置</Button>
                    </div>
                  </div>
                )}
              </CardContent>
                ...
                <div className='space-y-6'>
                  ...
                  <div>
                    ...
                    <Select
                      value={model}
                      onValueChange={value =>
                        setModel(value as typeof config.model)
                      }
                    >
                  ...
                  <div className='bg-blue-50 p-4 rounded-lg'>
                    ...
                    <ul className='text-sm text-blue-800 space-y-1'>
                      <li>
                        • API密钥用于调用DeepSeek AI服务，提供更智能的分析结果
                      </li>
                ...
                <div className='space-y-4'>
                  ...
                  <div className='flex items-center justify-between'>
                    ...
                    <Switch
                      ...
                      onCheckedChange={checked =>
                        updateNotification('sms', checked)
                      }
                    />
                  </div>
                </div>
                ...
                <div className='space-y-4'>
                  <div className='flex items-center justify-between'>
                    ...
                    <Switch
                      ...
                      onCheckedChange={checked =>
                        updatePrivacy('profileVisible', checked)
                      }
                    />
                  </div>
                  <div className='flex items-center justify-between'>
                    ...
                    <Switch
                      ...
                      onCheckedChange={checked =>
                        updatePrivacy('analysisPublic', checked)
                      }
                    />
                  </div>
                  <div className='flex items-center justify-between'>
